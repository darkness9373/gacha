...
const GACHA_ITEM = [
    { name: "Blue Flame Dragon", id: "rex:bluf", amount: 1, rate: 0.03, legend: true },
    
    { name: "Shulker Box", id: "shulker_box", amount: 1, rate: 0.05 },
    
    { name: "Trident", id: "trident", amount: 1, rate: 0.06 },
    
    { name: "Diamond Spear", id: "diamond_spear", amount: 1, rate: 0.07 },
    
    { name: "Diamond Sword", id: "diamond_sword", amount: 1, rate: 0.09 },
    
    { name: "Golden Sword", id: "golden_sword", amount: 1, rate: 0.11 },
    
    { name: "Iron Sword", id: "iron_sword", amount: 1, rate: 0.13 },
    
    { name: "Stone Sword", id: "stone_sword", amount: 1, rate: 0.14 },
    
    { name: "Copper Sword", id: "copper_sword", amount: 1, rate: 0.15 },
    
    { name: "Golden Apple", id: "golden_apple", amount: 10, rate: 0.17 },
];
...
OpenUI.entity('weapon_bluf', openChest)